    ...
    <div className="heroContainer min-h-[700vh]">
      ...
      <main className="heroMainContent">
        <h1 className="heroMainHeading">
          <span className="heroLine heroLine1">We Handle The Tech, You Handle The Growth.</span>
          <span className="heroLine heroLine2">From Websites & Apps To Custom Software, </span>
