...
function HeroSection() {
  ...
  return (
    <>
      {/* Fixed Hero Section - Added overflow-hidden to prevent white space */}
      <div
        ref={heroRef}
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Play/Pause Icon Overlay - MOVED TO LEFT SIDE */}
            <div
      ...
      {/* Global style to prevent white page on right side */}
      <style jsx global>{`
        html, body {
          margin: 0;
          padding: 0;
