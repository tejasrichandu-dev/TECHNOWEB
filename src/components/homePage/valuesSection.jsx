...
export default function ValuesSection() {
  ...
  return (
    <div className="relative z-30 md:z-20">
      <section 
        ref={sectionRef} 
        className="relative w-full min-h-screen bg-[#323235] text-white py-20"
      >
        <div className="max-w-6xl mx-auto px-6">
        {/* Header */}
        <div className="sticky top-10 z-20 flex justify-between items-center mb-10 mt-2 sm:mt-0">
...
function Card({ v }) {
  ...
  return (
    <div ref={cardRef} className="sticky top-60 flex justify-end">
      <div className="bg-[#232325] p-8 w-[380px] h-[380px] sm:w-[480px] sm:h-[480px] shadow-md relative overflow-hidden">
