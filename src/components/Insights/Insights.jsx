            ...
            >
              <div className="flex flex-col md:flex-row">
                ...
                <div className="md:w-1/2 p-6 flex flex-col justify-center relative">
                  ...
                  {/* Main Heading */}
                  <h3 className="text-lg md:text-xl font-semibold text-gray-700 mb-3 leading-relaxed">
                    {blogPosts[0].heading}
                  </h3>
                  {/* Tags after heading */}
                  <div className="flex gap-3 mb-4">
                    <span className="px-4 py-1.5 border border-gray-300 rounded-full text-gray-700 text-sm">
              ...
              {blogPosts.slice(1, 7).map((article, index) => (
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    {/* Heading */}
                    <h4 className="text-base font-semibold text-gray-700 mb-3 leading-relaxed">
                      {article.heading}
                    </h4>
                    {/* Tags after heading */}
